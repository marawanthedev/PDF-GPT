    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          PDF-GPT allows you to have conversations with any PDF documents.
          Simply Upload your file and start asking questions right away.
        </p>
        <Link
          href="/dashboard"
          target="_blank"
          className={buttonVariants({ className: "mt-5", size: "lg" })}
        >
          Get Started <ArrowRight className="ml-2 h-5 w-5" />
        </Link>
      </MaxWidthWrapper>

      {/* Value propostion sectin */}
      <div>
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <div className="mt-4 text-lg text-gray-600">
              Extracting information of your PDF files has never been easier
            </div>
          </div>
        </div>
        {/* steps */}
        ...
        >
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 zinc-700">
                it&apos;s that simple - it really takes less than a minutes;
              </span>
            </div>
          </li>
        </ol>
